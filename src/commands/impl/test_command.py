...
class TestCommand(Command):
    ...
    def validate_context(self, context: CommandContext) -> bool:
        ...
        try:
            ...
            required_fields = ["job_id", "fire_event_name", "geometry", "storage", "stac_manager", "index_registry"]
    ...
    async def execute(self, context: CommandContext) -> CommandResult:
        ...
        try:
            ...
            self.logger.info(f"Test command completed successfully for job {context.job_id}")
            return result

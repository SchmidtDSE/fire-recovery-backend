...
class CommandExecutionError(Exception):
    ...
    def __init__(self, command_name: str, original_error: Exception):
        ...
        super().__init__(f"Command '{command_name}' execution failed: {str(original_error)}")
    ...
    async def _execute_with_timeout(
        ...
        try:
            ...
            return CommandResult.failure(
                ...
                error_details={"timeout_seconds": timeout_seconds, "attempt": attempt + 1},
            )
            ...
            return CommandResult.failure(
                ...
                execution_time_ms=execution_time_ms,
                error_message=str(e),
                error_details={"exception_type": type(e).__name__, "attempt": attempt + 1},
            )
